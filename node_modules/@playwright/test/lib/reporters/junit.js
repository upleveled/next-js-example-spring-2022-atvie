...
class JUnitReporter {
  ...
  _addTestCase(test, entries) {
    ...
    entries.push(entry); // Xray Test Management supports testcase level properties, where additional metadata may be provided
    ...
    const systemErr = []; // attachments are optionally embed as base64 encoded content on inner <item> elements
