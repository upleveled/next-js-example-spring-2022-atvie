  ...
  mount: async ({
    ...
    await use(async (component, options) => {
      ...
      return Object.assign(locator, {
        ...
        rerender: async (component, options) => {
...
async function innerRerender(page, jsxOrType, options = {}) {
...
async function innerMount(page, jsxOrType, options = {}) {
  ...
  const selector = await page.evaluate(async ({
    ...
    await window.playwrightMount(component, rootElement, hooksConfig); // When mounting fragments, return selector pointing to the root element.
