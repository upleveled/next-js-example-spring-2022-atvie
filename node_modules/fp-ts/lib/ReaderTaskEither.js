 ...
 * @since 2.5.0
 */
exports.rightReaderTask = ET.rightF(RT.Functor);
/**
 * @category constructors
 * @since 2.5.0
 */
exports.leftReaderTask = ET.leftF(RT.Functor);
/**
 * @category constructors
 * @since 2.0.0
 */
 ...
 * @since 2.0.0
 */
var fromReaderEither = function (ma) { return (0, function_1.flow)(ma, TE.fromEither); };
 ...
 * @since 2.12.0
 */
exports.fromNullable = ET.fromNullable(RT.Pointed);
/**
 * @category interop
 * @since 2.12.0
 */
 ...
 * @since 2.0.0
 */
exports.mapLeft = ET.mapLeft(RT.Functor);
/**
...
var chainReaderTaskKW = function (f) {
    return (0, exports.chainW)((0, exports.fromReaderTaskK)(f));
};
...
var chainFirstReaderTaskKW = function (f) {
    return (0, exports.chainFirstW)((0, exports.fromReaderTaskK)(f));
};
