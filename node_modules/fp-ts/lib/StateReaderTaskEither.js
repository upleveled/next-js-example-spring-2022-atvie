 ...
 * @since 2.0.0
 */
exports.fromEither = E.match(function (e) { return (0, exports.left)(e); }, exports.right);
/**
 * @category natural transformations
 * @since 2.11.0
 */
 ...
 * @since 2.10.0
 */
exports.fromState = ST.fromState(RTE.Pointed);
/**
 * @category natural transformations
 * @since 2.0.0
 */
var fromTaskEither = function (ma) { return (0, exports.fromReaderTaskEither)(RTE.fromTaskEither(ma)); };
exports.fromTaskEither = fromTaskEither;
/**
 * @category natural transformations
 * @since 2.0.0
 */
var fromIOEither = function (ma) { return (0, exports.fromReaderTaskEither)(RTE.fromIOEither(ma)); };
 ...
 * @since 2.0.0
 */
exports.fromReaderTaskEither = ST.fromF(RTE.Functor);
// -------------------------------------------------------------------------------------
// combinators
// -------------------------------------------------------------------------------------
/**
 ...
 * @since 2.11.0
 */
var local = function (f) { return function (ma) { return (0, function_1.flow)(ma, R.local(f)); }; };
exports.local = local;
/**
 ...
 * @since 2.6.1
 */
var chainIOEitherKW = function (f) { return function (ma) { return (0, function_1.pipe)(ma, (0, exports.chainW)((0, exports.fromIOEitherK)(f))); }; };
 ...
 * @since 2.6.1
 */
var chainTaskEitherKW = function (f) { return function (ma) { return (0, function_1.pipe)(ma, (0, exports.chainW)((0, exports.fromTaskEitherK)(f))); }; };
 ...
 * @since 2.6.1
 */
var chainReaderTaskEitherKW = function (f) { return function (ma) { return (0, function_1.pipe)(ma, (0, exports.chainW)((0, exports.fromReaderTaskEitherK)(f))); }; };
 ...
 * @since 2.0.0
 */
exports.modify = (0, FromState_1.modify)(exports.FromState);
/**
 ...
 * @since 2.0.0
 */
exports.gets = (0, FromState_1.gets)(exports.FromState);
/**
 * @category combinators
 * @since 2.11.0
 */
 ...
 * @since 2.8.0
 */
exports.evaluate = ST.evaluate(RTE.Functor);
/**
 * Run a computation in the `StateReaderTaskEither` monad discarding the result
 *
 * @since 2.8.0
 */
exports.execute = ST.execute(RTE.Functor);
// -------------------------------------------------------------------------------------
// do notation
// -------------------------------------------------------------------------------------
/**
