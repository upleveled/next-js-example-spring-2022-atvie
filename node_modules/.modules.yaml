...
hoistedDependencies:
  ...
  /@emotion/use-insertion-effect-with-fallbacks/1.0.0_react@18.1.0:
  ...
  /@typescript-eslint/type-utils/5.38.0_t725usgvqspm5woeqpaxbfp2qu:
  ...
  /@typescript-eslint/utils/5.38.0_t725usgvqspm5woeqpaxbfp2qu:
  ...
  /eslint-module-utils/2.7.4_zeuoqv5fsrllwu7vh3rfouco4q:
    eslint-module-utils: public
  /eslint-plugin-jsx-a11y/6.6.1_eslint@8.14.0:
  ...
  /jest-circus/28.1.3:
    jest-circus: private
  /jest-cli/28.1.3_@types+node@17.0.31:
    jest-cli: private
  /jest-config/28.1.3_@types+node@17.0.31:
    jest-config: private
  /jest-diff/28.1.3:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Thu, 29 Sep 2022 11:41:23 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /esbuild-windows-64/0.15.9
  - /esbuild-windows-arm64/0.15.9
storeDir: /Users/upleveled/Library/pnpm/store/v3
